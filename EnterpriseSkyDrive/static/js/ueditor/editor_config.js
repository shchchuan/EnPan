...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,maxImageSideLength:100000                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //涂鸦图片配置区
        ,scrawlUrl:URL+"net/imageUp.ashx"           //涂鸦上传地址
        ,scrawlPath:URL+""                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"net/fileUp_Remote.ashx"               //附件上传提交地址
        ...
        ,toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                'Bold', 'Italic', 'Underline', 'Superscript', 'Subscript', 'RemoveFormat', 'FormatMatch', '|', 'PastePlain', 'wordimage', '|', 'ForeColor', 'BackColor', 'InsertOrderedList', 'InsertUnorderedList', '|','FontFamily', 'FontSize', '|',
                'Indent', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyJustify', '|',
                'Link', 'Unlink', 'Anchor', 'InsertImage','InsertVideo','attachment','Emotion', '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', 
