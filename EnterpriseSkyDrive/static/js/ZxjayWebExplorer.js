...
fileEditor.Content = "<div id='editorDiv'><input id='switchEditor' type='button' onclick='switchEditor()' value='切换编辑器' /><br /><textarea id='FileContentTextArea' name='FileContentTextArea' cols='80' rows='20' style='width:600px; height:400px;'></textarea></div>";
...
function createEditor()
{
    try {
        ...
        editor.render("FileContentTextArea");
...
function paste()
{
    ...
    dialog.Content = "确认将一下文件粘贴到当前目录：" + currentNode.path + "？<br /><div style='text-align:left;'>" + cutCopyFiles.join("<br />") + "</div>";
    dialog.Show();
...
$("tree").style.height = minheight + "px";
